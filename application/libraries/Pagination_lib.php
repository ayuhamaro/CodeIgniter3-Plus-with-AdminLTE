...
class Pagination_lib extends MY_Lib
{
    private $page_num;
    private $per_page;
    private $total_rows;
    ...
    public function pagination_link($show_page_count = 7)
    {
        ...
        return $this->CI->load->view('template/pagination/link', array('pagination' => $pagination_array), TRUE);
    }
    ...
    public function pagination_select($show_page_count = 7)
    {
        ...
        return $this->CI->load->view('template/pagination/select', array('pagination' => $pagination_array, 'button' => $button_array), TRUE);
    }
